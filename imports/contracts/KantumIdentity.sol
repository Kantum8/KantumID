...
/**
 * The contract is a Kantum ID, and all derived 'Kantum IDs' should match the bytecode
 * of a known 'good KantumIdentity' version. See the 'KantumIdentityRegistry' contract
 * for a mechanism for verifying valid KantumIdentities.
 */

contract KantumIdentity {
    ...
    /**
     * Constructor of the Kantum Identity
     */
    function KantumIdentity() {
        owner = msg.sender;
        override = owner;
